  ...
  const sendEmailHandler = async (event) => {
    ...
    try {
      const response = fetch(
        `https://mailbox-69d60-default-rtdb.firebaseio.com/${senderMail}/sentMails.json`,
        {
          method: 'Post',
    ...
    try {
      const response = fetch(
        `https://mailbox-69d60-default-rtdb.firebaseio.com/${recieverMail}/recievedMails.json`,
        {
          method: 'POST',
